        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">{t('accountSettings.google')}</p>
                <p className="text-xs text-gray-500">{t('accountSettings.notConnected')}</p>
              </div>
            </div>
          ...
          <p className="text-xs text-gray-500 text-center pt-2">
            {t('accountSettings.socialLoginComingSoon')}
          </p>
        </div>
      </div>
    </div>
